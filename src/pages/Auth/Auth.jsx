        ...
        <div>
          {
            <div>
              ...
              <input type={"email"} placeholder={userType === "staff" ? "Staff email" : "Student email"} className={`w-[400px] md:w-[85%] px-2 py-3 rounded-[10px] outline-none my-[2%] md:border md:border-gray-400 md:my-[2%]`} value={email} onChange={(e)=>setEmail(e.target.value)} required/>

              <div className=" relative">

              <input type={showPass===true ? "text" : "password"} placeholder={"Password"} className={`w-[400px] md:w-[85%] px-2 py-3 rounded-[10px] outline-none my-[2%] md:border md:border-gray-400 md:my-[2%]`} value={password} onChange={(e)=>setPassword(e.target.value)} onPaste={(e)=>e.preventDefault()} required/>
